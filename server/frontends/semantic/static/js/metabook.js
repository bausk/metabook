...
/***/ function(module, exports, __webpack_require__) {
	...
	GlobalGUI = (function(superClass) {
	  ...
	  GlobalGUI.prototype.initialize = function() {
	    ...
	    return this.listenTo(Backbone, 'metabook:ready', this.undim);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	Session = (function() {
	  ...
	  Session.prototype.onopen = function(evt) {
	    ...
	    return Backbone.trigger("connection:open", this);
	  };
	
	  Session.prototype.connect_file = function(path) {
	    this.file = new Promise((function(_this) {
	      return function(resolve, reject) {
	        ...
	        return _this.listenTo(Backbone, 'message:file:error', reject);
	      };
	    })(this));
	    return this.file;
	  };
